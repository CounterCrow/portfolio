...
public class HomeController {
	  ...
	  @RequestMapping(value="/payment") public String payment() {
		 ...
		 * 
		 * String apiUrl =
		 * "http://apis.data.go.kr/1471000/CovidDagnsRgntProdExprtStusService/getCovidDagnsRgntProdExprtStusInq?serviceKey=ZXC%2F7UsakCUJFoeRDuKkStvuc5GGSaU1sFdMupn4MqrCXpBBtGe8Ktv3V5uqxF7j9libofmzJkbsyOqmaE3QnQ%3D%3D&numOfRows=3&pageNo=1&type=json";
		 * 
		 ...
		 * 
		 * Map<String, Object> map = objectMapper.readValue(stringBuilder.toString(),
		 * Map.class);
		 * 
		 ...
		 * 
		 * String aaa = (String) header.get("resultCode"); String bbb = (String)
		 * header.get("resultMsg"); System.out.println("header.get(\"resultCode\"): " +
		 * header.get("resultCode")); System.out.println("header.get(\"resultMsg\"): " +
		 * header.get("resultMsg")); System.out.println(aaa); System.out.println(bbb);
		 * 
