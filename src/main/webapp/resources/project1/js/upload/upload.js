...
/* document.write("<script src='/resources/project1/js/upload/constants.js'></script>");
 document.write("<script src='/resources/project1/js/validation/validation.js'></script>");
